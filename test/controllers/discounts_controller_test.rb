...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { code: @discount.code, discount_percentage: @discount.discount_percentage, ticket_id: @discount.ticket_id }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { code: @discount.code, discount_percentage: @discount.discount_percentage, ticket_id: @discount.ticket_id }
    assert_redirected_to discount_path(assigns(:discount))
  end
